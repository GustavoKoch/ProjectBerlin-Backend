...
const list_all_calenderItems = async(req, res) => {
    ...
    try {
      const calenderItems = await CalenderItem.find({}, {start:1, end:1, title:1,activityList:1,contacts:1,img_url:1,description:1, category:1, _id:0} ).populate("contacts").populate("activityList");
